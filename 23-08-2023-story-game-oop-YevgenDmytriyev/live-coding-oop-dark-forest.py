class Character:
    ...
    def is_alive(self):  # evaluating the health
    ...
    def attack_enemy(self, enemy):
        enemy.take_damage(self.damage)  # When attacking the enemy is getting damage
...
class Mage(Character):
    ...
    def special_ability(self, enemy):
        self.health += 15
        for i in range(3):  # attack the enemy 3 times
...
class StoryGame:
    ...
    def play(self):
        print(f"Welcome {self.player.name} the amazing {type(self.player).__name__} ")
